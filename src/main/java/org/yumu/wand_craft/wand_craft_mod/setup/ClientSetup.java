...
import org.yumu.wand_craft.wand_craft_mod.entity.spell.magic_hook.MagicHookProjectileRenderer;
...
public class ClientSetup {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event){
        ...
        event.registerEntityRenderer(EntityRegisry.MAGIC_HOOK.get(), MagicHookProjectileRenderer::new);
    }
}
