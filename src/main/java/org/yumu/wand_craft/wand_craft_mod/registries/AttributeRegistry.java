...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> MANA_REGEN_NUM = ATTRIBUTES.register("mana_regen_num", ()->new MagicRangedAttribute("attribute.wand_craft.mana_regen_num",0.0D,0.0D,100.0D).setSyncable(true));
