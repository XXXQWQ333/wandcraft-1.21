...
import org.yumu.wand_craft.wand_craft_mod.spell.projectile.BombSpqll;
...
public class SpellRegistry {
    ...
    public static final DeferredHolder<AbstractSpell, BombSpqll> BOMB = registerSpell(new BombSpqll());
